 ...
 */
$this->registerCss("div.info{background: url(/img/wx/personal-bg.jpg) ; width: 100%; float:left; } div.info img{width: 70px; height: 70px; padding: 20px; float:left; } div.info span{padding: 20px 10px 0 10px; float: left; }");
?>
<div class="info">
