...
<!--    <p>This is the About page. You may modify the following file to customize its content:</p>
    ...
    <div class="about-page main grid-wrap">
            ...
            <hr>
                    <p class="fleft">固定收益</p>
            </header>



            <aside class="grid col-one-quarter mq2-col-full">
                    <p class="mbottom">固定收益类投资指投资于银行定期存款、协议存款、国债、金融债、企业债、可转换债券、债券型基金等固定收益类资产。
                    </p>
                    <menu>
                            <ul>
            ...
            <section class="grid col-three-quarters mq2-col-full">
                    <p style="text-align: center"><img src="/img/gudingshouyi.jpg" alt="" ></p>

                    <article id="navteam">
                    <br />
                    <p>固定收益是投资者按事先规定好的利息率获得的收益，如债券和存单在到期时，投资者即可领取约定利息。</p>
                    <p>固定收益类投资指投资于银行定期存款、协议存款、国债、金融债、企业债、可转换债券、债券型基金等固定收益类资产。</p>
                    <p>我们可以按照银行定期存款、国库券等金融产品的特性来理解“固定收益”的含义，一般来说，这类产品的收益不高但比较稳定，风险也比较低。</p>
                    </article>
