...
<!--    <p>This is the About page. You may modify the following file to customize its content:</p>
    ...
    <div class="about-page main grid-wrap">
            ...
            <hr>
                    <p class="fleft">股权投资</p>
            </header>



            <aside class="grid col-one-quarter mq2-col-full">
                    <p class="mbottom">指企业（或者个人）购买的其他企业（准备上市、未上市公司）的股票或以货币资金、无形资产和其他实物资产直接投资于其他单位，最终目的是为了获得较大的经济利益，这种经济利益可以通过分得利润或股利获取，也可以通过其他方式取得。
                    </p>
                    <menu>
                            <ul>
                                    <li><a href="/site/fixed-income" class="arrow">固定收益</a></li>
                                    <li><a href="/site/private-placement" class="arrow">定向增发</a></li>
                                    <li><a href="/site/equity-investment" class="arrow">股权投资</a></li>
            ...
            <section class="grid col-three-quarters mq2-col-full">
                    <p style="text-align: center"><img src="/img/guquantouzi.jpg" alt="" ></p>

                    <article id="navteam">
                    <br />
                    <p>股权投资，指通过投资取得被投资单位的股份。</p>
                    <p>是指企业（或者个人）购买的其他企业（准备上市、未上市公司）的股票或以货币资金、无形资产和其他实物资产直接投资于其他单位，最终目的是为了获得较大的经济利益，这种经济利益可以通过分得利润或股利获取，也可以通过其他方式取得。</p>
