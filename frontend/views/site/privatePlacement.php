...
<!--    <p>This is the About page. You may modify the following file to customize its content:</p>
    ...
    <div class="about-page main grid-wrap">
            ...
            <hr>
                    <p class="fleft">定向增发</p>
            </header>



            <aside class="grid col-one-quarter mq2-col-full">
                    <p class="mbottom">非公开发行即向特定投资者发行，也叫定向增发，中国股市早已有之。但是，作为两大背景下——即新《证券法》正式实施和股改后股份全流通——率先推出的一项新政，非公开发行同以前的定向增发相比，已经发生了质的变化。
                    </p>
                    <menu>
                            <ul>
            ...
            <section class="grid col-three-quarters mq2-col-full">
                    <p style="text-align: center"><img src="/img/dingxiangzengfa.jpg" alt="" ></p>

                    <article id="navteam">
                    <h2>定义</h2>
                    <p>非公开发行即向特定投资者发行，也叫定向增发，中国股市早已有之。</p>
                    <p>但是，作为两大背景下——即新《证券法》正式实施和股改后股份全流通——率先推出的一项新政，非公开发行同以前的定向增发相比，已经发生了质的变化。</p>
