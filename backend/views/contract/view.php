    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
            [
                'label' => '确认函扫描件',
                'format' => 'raw',
                'value' => $model->pdf == null ? Html::a('上传', ['contract/upload-confirmation', 'id' => $model->id, 'cat' => 'fixed'], ['class' => 'btn btn-primary btn-xs']) : $pdfUrl,
            ],
            [
                'label' => '删除确认函扫描件',
                'format' => 'raw',
                'value' => $model->pdf !== null ? Html::a('删除确认函', ['contract/delete-confirmation', 'id' => $model->id, 'cat' => 'fixed'], [
                    'class' => 'btn btn-danger',
                    'data' => [
                        'confirm' => '您确定要删除该确认函吗？',
                    ],
